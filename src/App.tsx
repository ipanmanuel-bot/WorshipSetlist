...
.pl-banner{padding:8px 14px;background:var(--bg2);border-top:1px solid var(--border);display:flex;align-items:center;justify-content:space-between;gap:8px;flex-wrap:wrap;}
.pl-banner-text{font-size:10px;color:var(--text2);font-family:'DM Sans',sans-serif;white-space:nowrap;}
.pl-banner-links{display:flex;gap:6px;}
.pl-social-btn{display:flex;align-items:center;gap:5px;padding:4px 10px;border-radius:20px;font-size:10px;font-weight:600;text-decoration:none;transition:all .15s;white-space:nowrap;-webkit-tap-highlight-color:transparent;}
.pl-social-btn.ig{background:linear-gradient(135deg,#f58529,#dd2a7b,#8134af);color:#fff;}
.pl-social-btn.tt{background:#010101;color:#fff;border:1px solid #333;}
.pl-social-btn:hover{transform:translateY(-1px);opacity:.9;}
            ...
            <div className="pl-footer-wrap">
              <div className="pl-banner">
                ...
                <div className="pl-banner-links">
                  <a href="https://www.instagram.com/ipanmanuel" target="_blank" rel="noopener noreferrer" className="pl-social-btn ig">
                  ...
                  <a href="https://www.tiktok.com/@ipanmanuel10" target="_blank" rel="noopener noreferrer" className="pl-social-btn tt">
